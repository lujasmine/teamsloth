...
public class Intersection {
    	public ArrayList<Point2D.Double> getIntersections(Path2D.Double path, Line2D.Double line) throws Exception {
        ...
        ArrayList<Point2D.Double> intersections = new ArrayList<Point2D.Double>(); //List to hold found intersections
